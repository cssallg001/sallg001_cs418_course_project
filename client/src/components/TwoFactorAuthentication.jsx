                ...
                if (userStateVal === false) {
                    ...
                    try {
                        ...
                        const response = await fetch(
                            'https://sallg001-cs418-course-project.onrender.com/user/register',
                            {
                                method: 'POST',
                                body: formBody,
                                headers: {
                        ...
                        if (
                            data.message === 'Account successfully registered'
                        ) {
                            navigate('/login')
                        } else {
    ...
    */
    ...
    function handleBackPage() {
        ...
        localStorage.setItem(
            'storedRegistrationSuccess',
            JSON.stringify(registrationSuccess)
        )
        if (userStateVal === 0) {
            navigate('/register')
                ...
                <form onSubmit={handleAuthentication}>
                    <div className="mb-3">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setEnteredVerificationVal(e.target.value)
                            }
                            required
                        />
                    </div>
